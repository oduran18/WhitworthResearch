...
function addProduct($p, $conn) {
    ...
    $sql = "INSERT INTO ProductDiscipline (DisciplineID, ProductID) SELECT DISTINCT R.DisciplineID, PR.ProductID FROM Researchers R, ProductResearcher PR WHERE R.ID=PR.ResearcherID";
    execInsert($sql, $conn);
}
